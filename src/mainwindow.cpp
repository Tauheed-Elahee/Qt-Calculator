...
void MainWindow::digit_pressed()
{
    ...
    else
    {
        ...
        {
            newLabel = (ui->label->text() + button->text().right(1)); // the first character in the returned field is &
        }
        else
        {
            labelNumber = (ui->label->text() + button->text().right(1)).toDouble(); // the first character in the returned field is &
            newLabel = QString::number(labelNumber,'g',15);
        }
